...
- Si utilizas la **matriz de correlación**, verifica que el archivo correspondiente se encuentre dentro de la carpeta **`data/`**.

---

## 2. Instalación de dependencias
Instala todas las librerías necesarias ejecutando el siguiente comando en tu terminal:
...
Para iniciar el proyecto, ejecuta el archivo principal con:
